...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[1]  = { {  432000, HFPLL, 2, 0x20 },  LVL_LOW,  950000, 2 },
	[2]  = { {  486000, HFPLL, 2, 0x24 },  LVL_LOW,  950000, 2 },
	[3]  = { {  540000, HFPLL, 2, 0x28 },  LVL_LOW,  950000, 2 },
	[4]  = { {  594000, HFPLL, 1, 0x16 },  LVL_LOW,  950000, 2 },
	[5]  = { {  648000, HFPLL, 1, 0x18 },  LVL_LOW,  950000, 4 },
	[6]  = { {  702000, HFPLL, 1, 0x1A },  LVL_LOW,  950000, 4 },
	[7]  = { {  756000, HFPLL, 1, 0x1C }, LVL_NOM,  1050000, 4 },
	[8]  = { {  810000, HFPLL, 1, 0x1E }, LVL_NOM,  1050000, 4 },
	[9]  = { {  864000, HFPLL, 1, 0x20 }, LVL_NOM,  1050000, 4 },
	[10] = { {  918000, HFPLL, 1, 0x22 }, LVL_NOM,  1050000, 5 },
	[11] = { {  972000, HFPLL, 1, 0x24 }, LVL_NOM,  1050000, 5 },
	[12] = { { 1026000, HFPLL, 1, 0x26 }, LVL_NOM,  1050000, 5 },
	[13] = { { 1080000, HFPLL, 1, 0x28 }, LVL_NOM,  1050000, 5 },
	[14] = { { 1134000, HFPLL, 1, 0x2A }, LVL_NOM,  1050000, 5 },
	[15] = { { 1188000, HFPLL, 1, 0x2C }, LVL_NOM,  1050000, 5 },
        [16] = { { 1242000, HFPLL, 1, 0x2E }, LVL_NOM,  1050000, 5 },
        [17] = { { 1350000, HFPLL, 1, 0x32 }, LVL_NOM,  1050000, 5 },
	[18] = { { 1458000, HFPLL, 1, 0x36 }, LVL_NOM,  1050000, 5 },
	[19] = { { 1566000, HFPLL, 1, 0x3A }, LVL_NOM,  1050000, 5 },
        [20] = { { 1674000, HFPLL, 1, 0x3E }, LVL_NOM,  1050000, 5 },
        [21] = { { 1728000, HFPLL, 1, 0x40 }, LVL_NOM,  1050000, 5 },
	{ }
};
...
static struct acpu_level tbl_PVS0_1700MHz[] __initdata = {
	...
	{ 1, {   162000, HFPLL, 2, 0x0C }, L2(0),   950000 },
	{ 1, {   270000, HFPLL, 2, 0x14 }, L2(0),   975000 },
	{ 1, {   378000, HFPLL, 2, 0x1C }, L2(0),  1000000 },
	...
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(17), 1175000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(18), 1200000 },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(19), 1225000 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(20), 1250000 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(21), 1275000 },
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(15), 1275000 },
	{ 1, {  1890000, HFPLL, 1, 0x46 }, L2(15), 1300000 },
	{ 1, {  1944000, HFPLL, 1, 0x48 }, L2(15), 1312500 },
	{ 1, {  1998000, HFPLL, 1, 0x4A }, L2(15), 1325000 },
#endif
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS1_1700MHz[] __initdata = {
	...
	{ 1, {   378000, HFPLL, 2, 0x1C }, L2(0),   975000 },
	...
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),  1000000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(6),  1000000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(10), 1025000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(10), 1050000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(12), 1075000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(15), 1100000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(16), 1125000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(17), 1150000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(18), 1175000 },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(19), 1200000 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(20), 1225000 },
...
static struct acpu_level tbl_PVS2_1700MHz[] __initdata = {
	...
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(17), 1125000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(18), 1150000 },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(19), 1175000 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(20), 1200000 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(21), 1225000 },
#ifdef CONFIG_CPU_OVERCLOCK
...
static struct acpu_level tbl_PVS3_1700MHz[] __initdata = {
	...
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(12), 1025000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(15), 1050000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(16), 1075000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(17), 1100000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(18), 1125000 },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(19), 1150000 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(20), 1175000 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(21), 1200000 },
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(15), 1225000 },
	{ 1, {  1890000, HFPLL, 1, 0x46 }, L2(15), 1250000 },
	{ 1, {  1944000, HFPLL, 1, 0x48 }, L2(15), 1275000 },
...
static struct acpu_level tbl_PVS4_1700MHz[] __initdata = {
	...
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(12), 1000000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(15), 1025000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(16), 1050000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(17), 1075000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(18), 1100000 },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(19), 1125000 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(20), 1150000 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(21), 1175000 },
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(15), 1200000 },
	{ 1, {  1890000, HFPLL, 1, 0x46 }, L2(15), 1212500 },
	{ 1, {  1944000, HFPLL, 1, 0x48 }, L2(15), 1250000 },
	{ 1, {  1998000, HFPLL, 1, 0x4A }, L2(15), 1267500 },
#endif
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS5_1700MHz[] __initdata = {
	...
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(16), 1025000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(17), 1050000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(18), 1075000 },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(19), 1100000 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(20), 1125000 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(21), 1150000 },
#ifdef CONFIG_CPU_OVERCLOCK
...
static struct acpu_level tbl_PVS6_1700MHz[] __initdata = {
	...
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(16), 1000000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(17), 1025000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(18), 1050000 },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(19), 1075000 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(20), 1100000 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(21), 1125000 },
#ifdef CONFIG_CPU_OVERCLOCK
